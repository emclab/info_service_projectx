...
module InfoServiceProjectx
  mattr_accessor :customer_class, :module_info_class #, :service_module_path, :support_module_path, :develop_mgmt_module_path, :customer_info_module_path, :ticket_module_path
