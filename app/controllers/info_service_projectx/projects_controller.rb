  ...
  class ProjectsController < ApplicationController
    ...
    def check_engine_config(project, engine_ids)
      ...
      engine_ids.each do |e_id|
        ...
        onboarded_arguments = OnboardDatax::OnboardEngineConfig.joins(:engine_config).where('onboard_datax_onboard_engine_configs.engine_id = ? AND onboard_datax_onboard_engine_configs.project_id = ?', e_id, project.id).select('argument_name, argument_desp').order('argument_name')
        output_string += "\n" +"\n" + "\n" +"\n" + '=============' + "#{engine_name}" + '===============' + "\n" + "\n" + "Onboarded Arguments" + "\n" + "\n"
